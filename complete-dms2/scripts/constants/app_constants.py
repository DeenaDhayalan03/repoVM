...
DEPLOYMENT_CREATE_FAILURE = "Failed to create deployment"
DEPLOYMENT_DELETE_SUCCESS = "Deployment deleted successfully"
DEPLOYMENT_DELETE_FAILURE = "Failed to delete deployment"
DEPLOYMENT_SCALE_SUCCESS = "Deployment scaled successfully"
DEPLOYMENT_SCALE_FAILURE = "Failed to scale deployment"
DEPLOYMENT_NOT_FOUND = "Deployment not found"
DEPLOYMENT_LIST_FAILURE = "Failed to list deployments"
